...
if data[1] < d.month:
    ...
    elif data[0] > d.day or data[0] == d.day:
        print(f"{data[0] - d.day} dias")
elif data[1] > d.month:
    print(f"Você tem {d.year-data[2]-1} anos, {d.month-data[1]+12} meses e ", end='')
    if data[0] < d.day:
        print(f"{d.day - data[0]} dias")
    elif data[0] > d.day or data[0] == d.day:
        print(f"{data[0] - d.day} dias")
